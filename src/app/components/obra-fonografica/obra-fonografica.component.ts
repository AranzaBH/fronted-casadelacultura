...
import { ObraFonograficaFormComponent } from './obra-fonografica-form.component';
import { ObraFonograficaShowComponent } from './obra-fonografica-show.component';
import { ObraFonografica } from './ObraFonografica';
import { ObraFonograficaService } from './obra-fonografica.service';
@Component({
    selector: 'app-obra-fonografica',
    templateUrl: './obra-fonografica.component.html',
    styleUrls:['./obra-fonografica.component.css'],
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
    ...
    DialogModule,
    ButtonModule,
    ObraFonograficaFormComponent,
    ObraFonograficaShowComponent,
    CardModule,
    SplitButtonModule,
    MenuModule 
  ]
...
export class ObraFonograficaComponent implements OnInit {
  listaObra: ObraFonografica []=[];
  selectObra: any;
  ...
  constructor(private obraService:ObraFonograficaService,private location: Location) {


  }

  editar(obra: ObraFonografica): void {
      this.abrirForm();
      this.selectObra = obra;
    }

    mostrar(obra: ObraFonografica): void {
      this.abrirShow();
      this.selectObra = obra;
    }
  ...
  abrirForm() {
    this.selectObra = new ObraFonografica();
